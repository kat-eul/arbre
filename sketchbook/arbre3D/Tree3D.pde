...
public class Tree3D{
  ...
  /** Génère un nouveau triangle suivant la procédure suivantes :
   *    - Génération d'un point A à une position aléatoire dans l'espace 3D
   *    - Recherche du triangle le plus proche de A soit closerTriangle
   *    - Génération d'un nouveau triangle sur l'axe de A vers closerTriangle,
   *      tel qu'il accole closerTriangle
   */
